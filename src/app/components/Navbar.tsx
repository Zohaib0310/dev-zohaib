    ...
    <div>
      <header>
        ...
        >
          ...
          >
            {showMenu ? <XCircleIcon /> : <Bars3CenterLeftIcon />}
          </button>
          <div
      ...
      {showMenu && (
        <div className="bg-white absolute right-full flex flex-col gap-4 z-10 top-18 w-full p-8 transition-transform duration-300 transform translate-x-full sm:translate-x-0">
          <Link
            to="about"
            smooth={true}
            duration={500}
